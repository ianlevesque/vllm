...
class HybridKVCacheCoordinator(KVCacheCoordinator):
    ...
    def __init__(
        ...
        # Under DCP (#53598) full-attention geometry is per-rank, so a mamba
        # group qualifies whenever its block size is at least the hash block
        # size — hits then stay hash-block aligned across both layer families.
